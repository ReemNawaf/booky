...
class AppColors {
  static const Color primaryColor = Color(0xFFCEE2AE);
  static const Color secondaryColor = Color(0xFFF4ADAA);
  static const Color backgroundColorDark = Color(0xFF272727);
